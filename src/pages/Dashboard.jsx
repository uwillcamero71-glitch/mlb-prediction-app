...
function Dashboard() {
  ...
  return (
    <div className="p-6 space-y-6 bg-gradient-to-b from-gray-900 to-gray-950 min-h-screen">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-bold text-white mb-2">⚾ MLB Prediction Dashboard</h1>
        <p className="text-gray-400">Welcome back! Here's your prediction summary with live accuracy</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-gray-800 rounded-lg p-6 shadow-lg">
          <h2 className="text-xl font-bold text-white mb-4">Prediction Accuracy Trend</h2>
          <PredictionChart />
        </div>
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-green-400">8.9/10</span>
            </div>
            <div className="w-full bg-gray-700 rounded-full h-2">
      ...
      {/* Upcoming Games */}
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        <h2 className="text-xl font-bold text-white mb-4">🎯 Upcoming Predictions</h2>
